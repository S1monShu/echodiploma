...
export default defineComponent({
    ...
    computed: {
      ...mapGetters(['getAuthUser', 'getRecommendedSongs', 'getArtist', 'getPlaylists']),
        getImageUrl() {
    ...
    methods: {
        ...mapActions(['playTrack', 'setEditAuthUser', 'showArtist', 'logOutUser']),
...
<template>
    <div class="user_section" >
        <div class="user_head">
            ...
            <div class="user_head_deco_mob">
                <img src="../../../images/user_deco_mob.png" alt="">
            </div>
        </div>
        <div class="user_profile_contents" >
            <div class="profile_contents_sections">
                <div class="section_option" @click="this.$store.dispatch('showArtist', this.getAuthUser.id)">
                    <input type="radio" id="mytracks" value="mytracks" v-model="checked">
                    <label class="option_label" for="mytracks">
                    <img v-if="this.checked === 'mytracks'" src="../../../images/option_background.png" alt="">
                ...
                <div class="section_option" @click="this.$store.dispatch('showArtist', this.getAuthUser.id)">
                    <input type="radio" id="playlists" value="playlistsPage" v-model="checked">
                    <label class="option_label" for="playlists">
                    <img v-if="this.checked === 'playlistsPage'" src="../../../images/option_background.png" alt="">
                    <img v-else src="../../../images/option_background_l.png" alt="">
                    <p>Плейлисты</p>
                    </label>
                </div>
            ...
            <div class="profile_contents_sections_mob">
                <div class="section_option">
                    <input type="radio" id="mytracks" value="mytracks" v-model="checked">
                    <label class="option_label" for="mytracks">
                    <img v-if="this.checked === 'mytracks'" src="../../../images/user_tracks_deco_mob.png" alt="">
                ...
                <div class="section_option">
                    <input type="radio" id="tracks" value="favoritesPage" v-model="checked">
                    <label class="option_label" for="tracks">
                    <img v-if="this.checked === 'favoritesPage'" src="../../../images/user_playlists_deco_mob.png" alt="">
                ...
                <div class="section_option">
                    <input type="radio" id="playlists" value="playlistsPage" v-model="checked">
                    <label class="option_label" for="playlists">
                    <img v-if="this.checked === 'playlistsPage'" src="../../../images/user_artists_deco_mob.png" alt="">
                    <img v-else src="../../../images/user_artists_deco_black_mob(1).png" alt="">
                    <p>Плейлисты</p>
                    </label>
                </div>
            </div>
            <div v-if="this.checked === 'mytracks'" class="user_profile_tracks" >
                <div class="user_profile_track" @click="this.$store.state.showAddSongModal = true">
                ...
                <div v-for="song in getArtist.songs" class="user_profile_track_el">
                        <div class="card_component">
                            <div class="song_btn">
            ...
            <div v-if="this.checked === 'playlistsPage'" class="user_profile_tracks" >
                <div class="user_profile_track" @click="this.$store.state.showAddPlaylistModal = true">
                    <div class="card_component">
                        <div class="song_img">
                            <span>
                                <div class="add_new_preview">
                ...
                <div v-for="playlist in getArtist.playlists" class="user_profile_track_el">
