...
export default defineComponent({
    ...
    methods: {
        ...mapActions(['setEditAuthUser']),
        changeImagePreview(payload){
            this.$store.state.auth.me.image = payload;
                    ...
                    <div class="modal_wrapper">
                        <span>
                            <div class="form_header">
                                <p class="form_title">Редактирование профиля</p>
                            ...
                            <div class="login_form">
                                <div class="input_container">
                                    <input type="text" v-model="this.$store.state.auth.me.name">
                                ...
                                <div class="input_container">
                                    <input id="email" v-model="this.$store.state.auth.me.email">
                                    <div class="input_deco l t" />
                                    <div class="input_deco l b" />
                                    <div class="input_deco r t" />
                                    <div class="input_deco r b" />
                                ...
                                <div class="input_file_container">
                                    <div class="avatar_preview">
                                        <span>
                                            ...
                                            <img v-if="!this.previewImage" :src="this.$store.state.auth.me.image" alt="">
                                            <img v-if="this.previewImage" :src="getImageUrl" alt="">
                                        </span>
                                    </div>
                                </div>
                                <button @click="setEditAuthUser" class="submit_btn" type="submit">
                                    <span @click="this.reloadPage()">
                                        <p>Редактировать</p>
                                    </span>
                                </button>
                            </div>
