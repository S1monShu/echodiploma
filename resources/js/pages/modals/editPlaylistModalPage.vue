...
export default defineComponent({
    ...
    computed: {
        ...mapGetters(['getAuthUser', 'getArtist', 'getPlaylist']),
        getImageUrl() {
            const imageBlob = new Blob([this.getPlaylist.image]);
    ...
    methods: {
        ...
        changeImagePreview(payload){
            this.getPlaylist.image = payload;
                    ...
                    <div class="modal_wrapper">
                        <span>
                            <div class="form_header">
                                <p class="form_title">Редактирование плейлиста</p>
                            ...
                            <div class="login_form">
                                <div class="input_container">
                                    <input type="text" v-model="getPlaylist.title">
                                ...
                                <div class="input_file_container">
                                    <div class="avatar_preview">
                                        <span>
                                            ...
                                            <img v-if="!this.previewImage" :src="getPlaylist.image" alt="">
                                            <img v-if="this.previewImage" :src="getImageUrl" alt="">
                                        </span>
                                    </div>
                                </div>
                                <button @click="editPlaylist(this.$route.params.id)" class="submit_btn" type="submit">
